...
if __name__ == '__main__':
    ...
    t2 = time()
    # AssertionError: Torch not compiled with CUDA enabled('epoch:0,train_time:{:.1f}s, HR:{:.4f}, NDCG:{:.4f}, test_time:{:.1f}s'.format(t1 - t1, hr, ndcg, t2 - t1))
    # 改动
    # model_out_file = 'C:/Users/wangxin/Desktop/pretrain/'+'/{}-{}-{}-{}-{}-lr_{}-HR_{:.4f}-NDCG_{:.4f}-epoch_{}.model'.format(model_name,
    #                                                                                                     dataset_name,
    #                                                                                                     latent_dim,
    #                                                                                                     layers,
    #                                                                                                     num_negative,
    ...
    #
                                                                                                         # 0)
    epoch=0
    model_out_file = 'C:/Users/wangxin/Desktop/pretrain/' + '/{}.model'.format(epoch)
    if args.out > 0:
